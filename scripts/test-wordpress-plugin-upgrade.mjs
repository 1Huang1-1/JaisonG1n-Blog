...
const REPLACEMENT_ZIP = path.join(
	...
	"wordpress-plugin",
	"dist",
	`${PLUGIN_SLUG}-0.9.0.zip`,
);

const baselinePlugin = `<?php
/**
 * Plugin Name: JaisonG1n Site Manager
 * Description: Minimal 0.8.3 upgrade-path fixture for article reviewed publishing testing.
 * Version: 0.8.3
 * Author: JaisonG1n
...
async function main() {
	...
	const baselineZip = path.join(temporaryDirectory, `${PLUGIN_SLUG}-0.8.3.zip`);
