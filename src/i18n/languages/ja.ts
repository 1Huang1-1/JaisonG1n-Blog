...
export const ja: Translation = {
	...
	[Key.diaryDaysAgo]: "日前",
	[Key.diaryEmpty]: "まだ日記はありません。今日の物語は始まったばかりです。",
	[Key.diaryViewFull]: "全文を見る",
	[Key.diaryBackToList]: "日記に戻る",
	[Key.diaryPrevious]: "前の日記",
	[Key.diaryNext]: "次の日記",
	[Key.diaryMood]: "気分",
	[Key.diaryLocation]: "場所",
	[Key.diaryTags]: "タグ",
	[Key.diaryImage]: "画像",
	[Key.diaryUntitled]: "日記",
	[Key.diaryNoLocation]: "場所未入力",
	[Key.diaryMoodHappy]: "嬉しい",
	[Key.diaryMoodCalm]: "穏やか",
	[Key.diaryMoodFulfilled]: "充実",
	[Key.diaryMoodExcited]: "興奮",
	[Key.diaryMoodThinking]: "思考中",
	[Key.diaryMoodTired]: "疲れた",
	[Key.diaryMoodAnxious]: "不安",
	[Key.diaryMoodSad]: "落ち込み",
	[Key.diaryMoodOther]: "その他",
